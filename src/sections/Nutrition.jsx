...
const Nutrition = () => {
  ...
  return (
    <section className="nutrition-section">
      ...
      <div className="flex md:flex-col justify-between md:px-10 px-5 mt-14 md:mt-0">
        <div className="relative inline-block md:translate-y-20 ">
          <div className="general-title relative flex flex-col justify-center items-center gap-24">
            ...
            <div style={{clipPath:"polygon(0% 0%, 0% 0%, 0% 100%, 0% 100%)"}} className="nutrition-text-scroll place-self-start">
              <div className="bg-yellow-brown pb-5 md:pt-0 pt-3 md:px-5 px-3 inline-block w-full">
                <h2 className="text-milk-yellow">Body Good</h2>
              </div>
            </div>
          </div>
        </div>
        <div className="flex md:justify-end items-center translate-y-1">
            ...
            {list.map((nutrient, index) => (
              <div key={index} className="relative flex-1 col-center">
                <div>
                    ...
                    <p className="text-sm mt-2 font-paragraph">upto</p>
